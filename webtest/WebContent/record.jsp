...
<body>
	...
	<div id="Container">
		...
		<div id="Content">
			<div id="Content-Left">
				<li style="line-height:200%">电子自动化设计</li>
				<li style="line-height:200%">物联网数据路由器</li>
				<li style="line-height:200%">云服务器软件开发</li>
				<li style="line-height:200%">QQ:22960468</li>
				<li style="line-height:200%">QQ:283441008</li>
				<li style="line-height:200%">QQ:281436586</li>
				<li style="line-height:200%">用数据增加利润</li>
			</div>

			<div id="Content-Main">
				<img src="image/lznet.jpg" />
			</div>
			
			<div id="Content-View">
				<img src="image/mycard.jpg" />
			</div>
		</div>
